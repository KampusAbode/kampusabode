    ...
    <section className="testimonials">
      <div className="container">
        ...
        <div className="testimonial">
          <blockquote>
            <p>
              “Kampabode helped me find the perfect apartment near campus within
              a week! The process was so easy, and I loved being able to chat
        ...
        <div className="testimonial">
          <blockquote>
            <p>
              ...
              properties faster than ever thanks to Kampabode’s easy-to-use
