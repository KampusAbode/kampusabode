  ...
  return (
    <section className="disclaimer">
      <div className="container">
        ...
        <p>
          Kampusabode provides this platform as a service to connect students and
        ...
        <p>
          ...
          Kampusabode does not guarantee the accuracy, completeness, or
        ...
        <p>
          Kampusabode does not endorse any agent, landlord, or property listing.
        ...
        <p>
          Kampusabode is not liable for any damages arising from the use of the
