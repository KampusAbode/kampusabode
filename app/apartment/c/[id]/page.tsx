    ...
    <div>
      ...
      <section>
        ...
        <ul>
          <li>
            ...
            (e.g., “2-Bedroom Flat near ETF Hall”).
          </li>
          <li>
          ...
          <li>
            <strong>Price:</strong> Rent amount and duration (monthly, yearly).
          </li>
          <li>
            <strong>Features:</strong> Include features like ensuite bathroom,
            kitchen, furnished, electricity, water, etc.
          </li>
          <li>
          ...
          <li>
            <strong>Description:</strong> Provide any additional information to
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            Agents are expected to respond to booking requests within 24 hours.
          </li>
          <li>
            Kampus Abode reserves the right to suspend or ban agents who violate
            listing standards.
          </li>
        </ul>
      </section>
      ...
      <div>
        <p>
          ...
          <span> or reach out to us on our </span>
          <a href="https://wa.me/2347050721686" target="_blank"> WhatsApp</a>.
          <span> for immediate assistance.</span>
        </p>
      </div>

      <div className="upload-btn">
        <a href={ `apartment/c/${user?.id}/upload`} className="btn"></a>
      </div>
    </div>
  );
}
