...
const validationSchema = Yup.object().shape({
  ...
  neighborhood_overview: Yup.string().required("Neighborhood overview is required"),
...
const UploadProperty = () => {
  ...
  const handleSubmit = async (values: any, { setSubmitting, resetForm, setStatus }: any) => {
    ...
    try {
      ...
      const propertyData: PropertyType = { ...values, imagess: imageUrls };
        ...
        {({ setFieldValue, isSubmitting, status }) => (
          <Form>
            ...
            <div className="form-group">
              ...
              <Field as="textarea" id="neighborhood_overview" name="neighborhood_overview" />
              <ErrorMessage name="neighborhood_overview" component="div" className="error" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <ErrorMessage name="bathrooms" component="div" className="error" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <ErrorMessage name="available" component="div" className="error" />
            </div>
