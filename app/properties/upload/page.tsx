  ...
  const handleSubmit = async (
    ...
    try {
      ...
      const propertyData: PropertyType = {
        ...
        approved: false, // default to false; to be approved later
        id: "", // will be generated by the database
        url: "", // will be provided in the response
      };

      console.log("Property Data:", propertyData);
      const response = await addProperty(propertyData);
      // Assume response returns: { success: string, url: string, propertyId: string }
        ...
        if (storedData) {
          try {
            ...
            if (
              ...
              userData.userInfo.propertiesListed = [
                ...userData.userInfo.propertiesListed,
                response.propertyId, // New property id returned from addProperty
              ];
